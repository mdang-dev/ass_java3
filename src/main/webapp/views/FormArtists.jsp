                            ...
                            <div class="mb-3 row g-3">
                                <div class="col-sm-10">
                                    <label for="exampleFormControlInput1"
                                        class="form-label">Tên Nghệ Sĩ</label>
                                    <input type="email"
                                        class="form-control"
                                ...
                                <div class="col-sm mt-3">
                                    <label for="exampleFormControlInput3"
                                        class="form-label">Mã Nghệ Sĩ</label>
                            ...
                            <div class="mt-3">
                                <div class="form-floating">
                                    <textarea class="form-control"
                                        ...
                                        style="height: 100px;resize: vertical; max-height: 300px;"></textarea>
                                    <label
                                        for="floatingTextarea2">Thêm Thông
                                        Tin</label>
                                </div>
                            </div>
                            <div class="mt-3">
